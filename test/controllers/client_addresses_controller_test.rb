...
class ClientAddressesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create client_address" do
    assert_difference('ClientAddress.count') do
      post client_addresses_url, params: { client_address: { address_id: @client_address.address_id, client_id: @client_address.client_id, id: @client_address.id } }
    end
  ...
  test "should update client_address" do
    patch client_address_url(@client_address), params: { client_address: { address_id: @client_address.address_id, client_id: @client_address.client_id, id: @client_address.id } }
