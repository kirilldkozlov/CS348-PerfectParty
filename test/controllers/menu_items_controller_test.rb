...
class MenuItemsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create menu_item" do
    assert_difference('MenuItem.count') do
      post menu_items_url, params: { menu_item: { id: @menu_item.id, item_id: @menu_item.item_id, menu_id: @menu_item.menu_id, quantity: @menu_item.quantity } }
    end
  ...
  test "should update menu_item" do
    patch menu_item_url(@menu_item), params: { menu_item: { id: @menu_item.id, item_id: @menu_item.item_id, menu_id: @menu_item.menu_id, quantity: @menu_item.quantity } }
