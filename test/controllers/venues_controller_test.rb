...
class VenuesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create venue" do
    assert_difference('Venue.count') do
      post venues_url, params: { venue: { cost: @venue.cost, id: @venue.id, name: @venue.name } }
    end
  ...
  test "should update venue" do
    patch venue_url(@venue), params: { venue: { cost: @venue.cost, id: @venue.id, name: @venue.name } }
