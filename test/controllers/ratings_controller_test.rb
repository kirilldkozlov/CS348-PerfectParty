...
class RatingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create rating" do
    assert_difference('Rating.count') do
      post ratings_url, params: { rating: { id: @rating.id, supplier_id: @rating.supplier_id } }
    end
  ...
  test "should update rating" do
    patch rating_url(@rating), params: { rating: { id: @rating.id, supplier_id: @rating.supplier_id } }
