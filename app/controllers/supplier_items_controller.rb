class SupplierItemsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @supplier_item.save
        ...
        format.json { render :show, status: :created, location: @supplier_item }
      else
  ...
  def update
    respond_to do |format|
      if @supplier_item.update(supplier_item_params)
        ...
        format.json { render :show, status: :ok, location: @supplier_item }
      else
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to supplier_items_url, notice: 'Supplier item was successfully destroyed.' }
  ...
  private
    ...
    def supplier_item_params
      params.require(:supplier_item).permit(:id, :supplier_id, :item_id, :quantity, :cost)
    end
end
